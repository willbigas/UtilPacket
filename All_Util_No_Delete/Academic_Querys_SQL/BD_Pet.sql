...
CREATE TABLE `animal` (
  ...
  `idTipoAnimal` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `animal_tipoanimal_idx` (`idTipoAnimal`),
  CONSTRAINT `animal_tipoanimal` FOREIGN KEY (`idTipoAnimal`) REFERENCES `tipoanimal` (`id`)
...
INSERT INTO `tipoanimal` VALUES (1,'Gato','descrição alterado'),(2,'Cachorro','au auauau'),(3,'Pato','quac '),(4,'Cavalo','kfjdsjkfj ks'),(5,'Vaca','mumuuu');
...
-- Dump completed on 2018-08-31 22:08:04

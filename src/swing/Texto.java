...
public class Texto {
    ...
    public static final String SUCESSO_CRIAR = "Cadastrado com Sucesso!";
    ...
    public static final String SUCESSO_SAIDA = "Saída gravada com sucesso";
    public static final String SUCESSO_ENTRADA = "Entrada gravada com sucesso";

    // Mensagens de Erro Padrões
    public static final String ERRO_DELETAR = "Erro ao excluir";
    public static final String ERRO_CRIAR = "Erro ao Cadastrar!";
    public static final String ERRO_EDITAR = "Erro ao Editar!";
    public static final String ERRO_ENTRADA = "Erro ao gravar Entrada";
    public static final String ERRO_SAIDA = "Erro ao Gravar a Saida";
    ...
    public static final String EXCLUIR_PERGUNTA = "Você deseja Realmente excluir ";
